...
class PupilDetect {
    ...
    void findEyes(cv::Mat frame_gray, cv::Rect face) {
      ...
      int eye_region_height = face.width * 1.5 * (kEyePercentHeight/100.0);
      ...
      cv::Rect rightEyeRegion(face.width - eye_region_width - face.width*(kEyePercentSide/100.0),
        ...
        if(faceROI.rows > 0) {
          cv::namedWindow("debug 2",CV_WINDOW_NORMAL);
            //imshow("debug 2", faceROI(leftEyeRegion));
